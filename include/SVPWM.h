...
void testClarkeOpenLoop(float amplitude, float velocity, float sampleTime, bool isCCW=true);
void applySVPWM(float v_d, float v_q, float theta_rad);
void testParkOpenLoop(float v_d, float v_q, float velocity, float sampleTime, bool isCCW=true);
