...
// (0) System constants
#define SVPWM_FREQUENCY             4000.0                                 // 10 kHz PWM frequency
#define POSITION_CONTROL_FREQUENCY  1000.0                                  // 2 kHz position control frequency
#define DEBUG_FREQUENCY             50.0                                   // 100 Hz debug frequency
